                    ...
                    <div class="card rounded-4 card-active ">
                        <div class="card-body">
                            ...
                            <div class="px-5">
								...
								<tbody>
								  <?php
								  $ambildata = mysqli_query($conn, "SELECT * FROM tb_surat_izin, tb_jenis_izin WHERE tb_surat_izin.id_jenis_izin = tb_jenis_izin.id_jenis_izin AND tb_surat_izin.verifikasi = 'Pending' AND tb_surat_izin.id_surat_izin = '".$AtasanDetail['nip_user']."'");
								  $i = 1;
								  while ($data = mysqli_fetch_array($ambildata)) {
                                  ...
                                  <form action="" method="POST">
                                   ...
                                   <?php
                                        if (isset($_POST['approve'])){
                                            $queryupdateuser = mysqli_query($conn, "UPDATE tb_surat_izin SET verifikasi = 'Disetujui'");
                                            if ($queryupdateuser) {    
                                                echo "<script> 
                                                alert('Form Berhasil Disetujui');
                                                window.open('atasan.php','_self');
                                                     </script>";
                                             } else {
                                        ...
                                        if (isset($_POST['tolak'])){
                                            $queryupdateuser = mysqli_query($conn, "UPDATE tb_surat_izin SET verifikasi = 'Ditolak'");
                                            if ($queryupdateuser) {    
                                                echo "<script> 
                                                alert('Form Berhasil Ditolak');
                                                window.open('atasan.php','_self');
                                                     </script>";
                                             } else {
                                                echo "Gagal Edit Data";
